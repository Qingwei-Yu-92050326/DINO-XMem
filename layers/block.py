...
# NOTE:
# DINOv3 was developed with a newer PyTorch stack. Some torch._dynamo config knobs
# may not exist in older versions (e.g. torch 2.1). Guard these assignments so that
# importing the backbone does not crash.
try:  # pragma: no cover
